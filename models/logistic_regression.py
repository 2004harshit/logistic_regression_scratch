...
class LogisticRegression:
    ...
    def sigmoid(self, z):
        ...
        The sigmoid function is a mathematical function which squashes
        the higher signdistances of datapoints from hyper plane

        Parameters:
            z(float or numpy.ndaray): The input value for which
